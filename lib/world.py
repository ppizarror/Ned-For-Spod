...
from bin.errors import ERROR_HEADER, throw, \
    ERROR_TRACKNOTEXIST  # @UnusedImport
    ...
    def load_map(self, index=None):
        ...
        if index == 1:
            try:
                ...
                self.actualMap.setObjetives(
                    [(17.5, 19.5, 23.5), (17.0, 19.2, 22.5),
                     (15.5, 17.1, 20.0)])
                # Se define el fondo del mundo
                self.actualMap.setBackground(
                    self.load_image("grass", alpha=False))
                # Se agrega al jugador
                self.actualMap.addCar(int(self.userConfig.getValue("TYPECAR")),
                ...
                self.actualMap.addTrack(
                    ...
                    (100, 200))
                self.actualMap.addTrack(self.load_image("c1_1", alpha=True),
                                        (500, 200))
                self.actualMap.addTrack(self.load_image("c2_1", alpha=True),
                                        (500, -200))
                self.actualMap.addTrack(self.load_image("c4_4", alpha=True),
                                        (100, -300))
                self.actualMap.addTrack(self.load_image("c3_2", alpha=True),
                                        (-100, -1000))
                self.actualMap.addTrack(
                ...
                self.actualMap.addTrack(
                    ...
                    (500, -1185))
                self.actualMap.addTrack(self.load_image("c2_3", alpha=True),
                                        (1100, -900))
                self.actualMap.addTrack(
                    self.load_image("rect_h_4", alpha=True),
                    (1100, -600))
                self.actualMap.addTrack(self.load_image("rect_h", alpha=True),
                                        (1100, -300))
                self.actualMap.addTrack(self.load_image("rect_h", alpha=True),
                                        (1100, 0))
                self.actualMap.addTrack(self.load_image("rect_h", alpha=True),
                ...
                self.actualMap.addTrack(
                    ...
                    (700, 1000))
                self.actualMap.addTrack(self.load_image("rect_w", alpha=True),
                                        (400, 1000))
                self.actualMap.addTrack(self.load_image("rect_w", alpha=True),
                                        (200, 1000))
                self.actualMap.addTrack(self.load_image("rect_w", alpha=True),
                ...
                self.actualMap.addTrack(
                    ...
                    (-400, 1000))
                self.actualMap.addTrack(self.load_image("c4_2", alpha=True),
                                        (-700, 1000))
                self.actualMap.addTrack(self.load_image("c3_3", alpha=True),
                                        (-600, 500))
                self.actualMap.addTrack(
                    self.load_image("rect_w_1", alpha=True),
                    (-300, 215))
        ...
        # Pista 2 - Adelaide raceway
            ...
            try:
                ...
                self.actualMap.addTrack(
                    self.load_image("rect_w_1", alpha=True),
                    (-1900, 215))
                self.actualMap.addTrack(self.load_image("c3_4", alpha=True),
                                        (-2200, 600))
                self.actualMap.addTrack(
                ...
                self.actualMap.addTrack(self.load_image("c1_1", alpha=True),
                                        (-600, 1000))
                self.actualMap.addTrack(self.load_image("c3_1", alpha=True),
                                        (-500, 600))
                self.actualMap.addTrack(self.load_image("c2_2", alpha=True),
                                        (0, 700))
                self.actualMap.addTrack(self.load_image("c4_3", alpha=True),
                                        (300, 1300))
                self.actualMap.addTrack(
                    self.load_image("rect_w_4", alpha=True),
                    (600, 1300))
                ...
                self.actualMap.addTrack(
                    self.load_image("rect_w_2", alpha=True),
                    (1800, 815))
                self.actualMap.addTrack(self.load_image("c4_1", alpha=True),
                                        (1500, 800))
                self.actualMap.addTrack(self.load_image("c2_2", alpha=True),
                                        (1400, 400))
                self.actualMap.addTrack(
        ...
        # Pista 3 - Riverside intl
            ...
            try:
                ...
                # Se agregan los caminos
                self.actualMap.addTrack(self.load_image("goal_w", alpha=True),
                                        (0, 0))
                self.actualMap.addTrack(self.load_image("rect_w", alpha=True),
                                        (-300, 0))
                self.actualMap.addTrack(self.load_image("rect_w", alpha=True),
                ...
                self.actualMap.addTrack(self.load_image("c4_4", alpha=True),
                                        (100, 2000))
                self.actualMap.addTrack(self.load_image("c1_4", alpha=True),
                                        (800, 2000))
                self.actualMap.addTrack(self.load_image("c3_1", alpha=True),
                                        (900, 1300))
                self.actualMap.addTrack(
                ...
                self.actualMap.addTrack(
                    self.load_image("rect_w_3", alpha=True),
                    (2100, 1200))
                self.actualMap.addTrack(self.load_image("c1_2", alpha=True),
                                        (2600, 1200))
                self.actualMap.addTrack(self.load_image("rect_h", alpha=True),
                                        (2600, 700))
                self.actualMap.addTrack(self.load_image("c2_4", alpha=True),
                                        (2600, 400))
                self.actualMap.addTrack(
                    self.load_image("rect_w_2", alpha=True),
                    (1900, 15))
        ...
        # Santiago intl
            ...
            try:
                ...
                # Se agregan los caminos
                self.actualMap.addTrack(self.load_image("goal_h", alpha=True),
                                        (0, 0))
                self.actualMap.addTrack(self.load_image("rect_h", alpha=True),
                                        (0, 300))
                self.actualMap.addTrack(self.load_image("rect_h", alpha=True),
                ...
                self.actualMap.addTrack(self.load_image("c3_3", alpha=True),
                                        (-1400, -400))
                self.actualMap.addTrack(self.load_image("c1_3", alpha=True),
                                        (-1700, 200))
                self.actualMap.addTrack(
                    self.load_image("rect_w_3", alpha=True),
                    (-2300, 200))
