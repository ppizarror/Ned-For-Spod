    ...
    def update(self, events):
        ...
        for event in events:
            ...
            if event.type == KEYDOWN:
                ...
                elif event.key == K_RETURN and len(self.value) > 3: return self.value
...
def request(title, inputtext):
    ...
    window_title_pos = [(0, 0), (SCREEN_SIZE[0], 0), (SCREEN_SIZE[0], int(window_title_fontsize / 2)), (window_title_width + 15, int(window_title_fontsize / 2)), \
    ...
    while True:
        ...
        for event in events:
            if event.type == QUIT: return NO_VALID_NAME
